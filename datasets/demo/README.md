...
- `manifest.json`: manifiesto versionado con fuente, checksum SHA-256 por archivo, cobertura, zona horaria, definición de precio y limitaciones.
- `instruments.json`: cuatro instrumentos de referencia (tres en COP, uno en USD no operable en el MVP; uno INACTIVE).

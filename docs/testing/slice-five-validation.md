...
Fecha: 2026-09-11. Requirements: PED-001, PED-002, PORT-002, SEC-001, EDU-001.
...
- La interfaz explica en contexto los datos de mercado, las previews, las métricas y la simulación histórica mediante bloques ampliables accesibles.
...
| `npm run test:e2e`                        | 19 pruebas aprobadas con `E2E_DATABASE_URL` dedicada |

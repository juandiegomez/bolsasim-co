...
Hay una tensión externa todavía sin resolver: el MVP exige cierres reales gratuitos de acciones colombianas, pero las fuentes revisadas no han demostrado simultáneamente gratuidad, cobertura, semántica de cierre y permiso de uso. ADR-0005 la registra como decisión bloqueante, sin rebajar el requisito ni disfrazar fixtures como datos reales.
...
- compras COP con fracciones, fees cero y retorno bruto;
...
| -------------------------------------------------------- | --------------------------------------- | ----------------------------------------------------------------- |
| No encontrar cierres colombianos gratuitos y utilizables | Bloquea aceptación de slices de mercado | validar candidatos contra ADR-0005 antes de integrar              |
...
La selección de datos reales permanece abierta y no impide construir infraestructura, ledger o mock contractual; sí impide declarar terminados para MVP los slices 2, 3 y 4.
